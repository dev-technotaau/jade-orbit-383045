 ...
 *
 * SHARED SHAPE with `frontend/src/lib/wa-phone-region.ts` — the contact panel
 * shows the estimate and the campaign worker acts on it, and the two must agree
 * about what hour it is where the customer is. Kept as a copy rather than a
 * shared package because the two halves of this repo have no common module.
 *
